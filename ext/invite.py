...
class Invite(ext.Cog):
    ...
    @ext.command(name='invite',
                 aliases=['iv', 'in', 'iinv', 'innv', 'invv', 'niv', 'ivn', 'unv', '8nv', '9nv', 'onv', 'lnv',
                          ...
                          'joinm', 'nooi', 'ادعُ', 'поканете', 'আমন্ত্রণ', 'convidar', 'pozvat', 'einladen', 'καλώ',
                          'invitar', 'kutsuda', 'دعوت', 'kutsua', 'invitez', 'આમંત્રિત', 'gayyata', 'להזמין',
                          'आमंत्रित करना', 'pozovi', 'meghív', 'undang', '招待', '초대', 'pakviesti', 'uzaicināt',
                          'आमंत्रित करा', 'jemput', 'ਸੱਦਾ', 'zaproś', 'a invita', 'pozvať', 'позвати', 'bjud in',
                          'kukaribisha', 'அழைக்கவும்', 'ఆహ్వానించండి', 'เชิญ', 'davet etmek', 'запросити', 'دعوت دینا',
                          'mời', '邀请', '邀請', 'आमंत्रितकरना', 'आमंत्रितकरा', 'دعوتدینا'],
