...
class Invite(ext.Cog):
    ...
    @ext.command(name='invite',
                 aliases=['nv', 'iv', 'in', 'iinv', 'innv', 'invv', 'niv', 'ivn', 'unv', '8nv', '9nv', 'onv', 'lnv',
                          'knv', 'jnv', 'ibv', 'ihv', 'ijv', 'imv', 'inc', 'inf', 'ing', 'inb', 'uinv', 'iunv', '8inv',
                          ...
                          'supporth', 'supportg', 'supportf', 'invite', 'inv', 'server', 'support', 'addbot', 'join',
