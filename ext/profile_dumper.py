...
class ProfileDump(ext.Cog):
    ...
    @ext.command(name='profiledump',
                 aliases=['profile_dump', 'profile-dump', 'profd', 'ump', 'dmp', 'dup', 'dum', 'ddump', 'duump',
                          ...
                          'dumjp', 'dumkp', 'dumop', 'dumpo', 'dum0p', 'dump0', 'dumlp', 'dumpl', 'ave', 'sve', 'sae',
                          'sav', 'ssave', 'saave', 'savve', 'savee', 'asve', 'svae', 'saev', 'aave', 'wave', 'eave',
                          'dave', 'xave', 'zave', 'sqve', 'swve', 'ssve', 'sxve', 'szve', 'sace', 'safe', 'sage',
                          'sabe', 'savw', 'sav3', 'sav4', 'savr', 'savf', 'savd', 'savs', 'asave', 'wsave', 'swave',
                          'esave', 'seave', 'dsave', 'sdave', 'xsave', 'sxave', 'zsave', 'szave', 'sqave', 'saqve',
                          'sawve', 'sasve', 'saxve', 'sazve', 'sacve', 'savce', 'safve', 'savfe', 'sagve', 'savge',
                          'sabve', 'savbe', 'savwe', 'savew', 'sav3e', 'save3', 'sav4e', 'save4', 'savre', 'saver',
                          'savef', 'savde', 'saved', 'savse', 'saves', 'rofiledump', 'pofiledump', 'prfiledump',
