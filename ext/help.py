...
class Help(ext.Cog):
    ...
    @ext.command(name='help',
                 aliases=['/h', '/how', '/?', '/help', '/commands', '/command', '/cmds', '/cmd', '/what', '/list',
                          ...
                          'hulp te vertoon', 'التعليمات', 'помощ', 'সাহায্য', 'ajuda', 'Pomoc', 'hjælp', 'Hilfe',
                          'βοήθεια', 'ayuda', 'abi', 'کمک', 'auta', 'aide', 'મદદ', 'taimako', 'עֶזרָה', 'मदद', 'pomoći',
                          'Segítség', 'bantuan', 'ヘルプ', 'padėti', 'palīdzēt', 'मदत', 'ਮਦਦ ਕਰੋ', 'pomocy', 'Ajutor',
                          'справке', 'помоћ', 'hjälp', 'msaada', 'உதவி', 'సహాయం', 'yardım', 'довідка', 'مدد',
                          'trợ giúp', '帮助', '幫助', 'hulptevertoon', 'hulp', 'trợgiúp'],
                 extras={'emoji': "info",
