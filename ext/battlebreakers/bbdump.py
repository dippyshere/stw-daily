...
class BBDump(ext.Cog):
    ...
    @ext.command(name='bbdump',
                 aliases=['bbprofiledump', 'bbprofile_dump', 'bbprofile-dump', 'battlebreakersdump', '/bbdump', 'bdump',
                          ...
                          '转储', '轉儲', 'bbdumpe', 'bbdumb', 'bbdqmp', 'badump', 'jbbdump', 'bbdxmp', 'bbdudmp',
                          'btdump', 'brdump', 'bbdutmp', 'bjdump', 'bzdump', 'bybdump', 'dbbdump', 'bbduvp', 'bbdumpw',
                          'tbbdump', 'bbdumi', 'babdump', 'bbdumj', 'brbdump', 'bbdumpx', 'lbbdump', 'mbdump',
                          'bbdumzp', 'bbduip', 'bxdump', 'bbduemp', 'dbdump', 'bqbdump', 'bbdumtp', 'rbdump', 'bbdumr',
                          'zbdump', 'bibdump', 'bbdamp', 'bbdwump', 'bbuump', 'bbdubp', 'bbdumgp', 'bbyump', 'bpbdump',
                          'bsbdump', 'ybbdump', 'bbduup', 'bbqump', 'bbdbmp', 'bbdumpz', 'bbdnump', 'bbdumv', 'bxbdump',
                          'bbvump', 'bbdsmp', 'bbdumpu', 'bbdmmp', 'bedump', 'bbdumpm', 'bbdumxp', 'bbkdump', 'bbzump',
                          'bbdumhp', 'bwbdump', 'bbduqmp', 'bbdumpd', 'bbdumu', 'abbdump', 'bbdwmp', 'bbhump',
                          'bebdump', 'pbdump', 'bbdumpy', 'bbduzmp', 'bfbdump', 'bldump', 'bbduhp', 'bbduwp', 'bbdoump',
                          'bbdumm', 'budump', 'bbdume', 'cbdump', 'btbdump', 'bbduvmp', 'bdbdump', 'bbdumrp', 'bbdumpg',
                          'bydump', 'bbdusp', 'qbdump', 'sbbdump', 'bbdumk', 'bbdutp', 'mbbdump', 'bbdupp', 'bbdumep',
                          'bbduqp', 'bsdump', 'bbydump', 'bbkump', 'bbdumcp', 'bbdums', 'bbdrmp', 'bbdumsp', 'bbdnmp',
                          'jbdump', 'bkbdump', 'abdump', 'bbdumpk', 'bcdump', 'bbjdump', 'qbbdump', 'bbdaump', 'bbduyp',
                          'bbdmump', 'bbdumvp', 'bbdugmp', 'bbzdump', 'bbdumpb', 'bbdumw', 'bbdumh', 'bubdump',
                          'bwdump', 'bbdlump', 'bbdzump', 'bbdumfp', 'bbdumpi', 'bbmump', 'cbbdump', 'bbdumpv',
                          'bbdqump', 'obbdump', 'bbduap', 'ebdump', 'bbdgmp', 'bbduma', 'bblump', 'bodump', 'blbdump',
                          'bbduxmp', 'obdump', 'bkdump', 'sbdump', 'bbdumn', 'bbdumpf', 'bbdlmp', 'bbdumf', 'bbodump',
                          'bmbdump', 'bbdufmp', 'bbbump', 'ubdump', 'bbdumpa', 'bmdump', 'bbldump', 'kbdump', 'pbbdump',
                          'xbbdump', 'bbdtump', 'xbdump', 'rbbdump', 'bbdumqp', 'bbdumq', 'bbdzmp', 'bbdumy', 'bbducmp',
                          'bbdupmp', 'bbdvump', 'bbdurp', 'bbdfmp', 'bbdurmp', 'bbdumbp', 'bboump', 'bpdump', 'ebbdump',
                          'zbbdump', 'fbbdump', 'kbbdump', 'bbddmp', 'bbiump', 'bbdulmp', 'ybdump', 'wbdump', 'bbdumyp',
                          'bbdumz', 'bbjump', 'lbdump', 'bbdcmp', 'bbdumdp', 'bbnump', 'bbmdump', 'bbdtmp', 'ibdump',
                          'bbdumg', 'bcbdump', 'bbduzp', 'bbdomp', 'bbdumpj', 'bbduwmp', 'bbpdump', 'bbdugp', 'bbaump',
                          'bbdumpt', 'bbgump', 'bbpump', 'bbwdump', 'bbduomp', 'bbdulp', 'bfdump', 'bbdumps', 'bbdumup',
                          'bbdusmp', 'ibbdump', 'bbduamp', 'bbdvmp', 'bbduop', 'bbduep', 'bbdumph', 'ubbdump', 'fbdump',
                          'bbqdump', 'bbdumx', 'bbdudp', 'bbdumc', 'bbdpmp', 'bbdumpn', 'bbtump', 'bbdpump', 'bidump',
                          'bbdumd', 'bbducp', 'bjbdump', 'tbdump', 'wbbdump', 'bbadump', 'bbdumpr', 'bbudump',
                          'bobdump', 'bzbdump', 'bddump', 'bbdumwp', 'bbdumip', 'bbdufp', 'bbdumpq', 'bbdubmp',
                          'bqdump', 'bbdbump', 'bbdemp', 'bbduxp', 'bbdumpc', 'bbtdump', 'bbdumap', 'bbwump', 'bbdumt',
                          'bbidump', 'bbdgump', 'bbd6mp', 'bbd^mp', 'bbd&mp', 'bbd*mp', 'bbdu,p', 'bbdu<p', 'bbdum9',
                          'bbdum-', 'bbdum[', 'bbdum]', 'bbdum;', 'bbdum(', 'bbdum)', 'bbdum_', 'bbdum=', 'bbdum+',
                          'bbdum{', 'bbdum}', 'bbdum:', 'bbsaeve', 'bbstave', 'bbsae', 'bsave', 'xbsave', 'bbsape',
                          'btbsave', 'bbasve', 'bbsaev', 'bbsavde', 'bbqsave', 'bqbsave', 'bbsove', 'cbsave', 'sbsave',
                          'bbsav', 'bsbave', 'bbsadve', 'bbsvave', 'bbsyave', 'bbave', 'bbswve', 'lbsave', 'bbwsave',
                          'bbsave', 'bbsve', 'bbsavie', 'bbsavel', 'bbisave', 'bbseave', 'bbsahe', 'bbsdve', 'bbsavve',
                          'bssave', 'bnbsave', 'bbsatve', 'bbsavx', 'bbsvae', 'bbsavte', 'bbbave', 'bbszve', 'abbsave',
                          'bbsgve', 'bbsaae', 'pbsave', 'bbstve', 'bbcave', 'bobsave', 'bjsave', 'bbsavet', 'bbsavec',
                          'gbbsave', 'bbsbve', 'bbsavqe', 'bbsavt', 'bbsavf', 'bbsavoe', 'bbsavze', 'bbvave', 'bbtave',
                          'bbspave', 'bpsave', 'zbsave', 'bbeave', 'jbsave', 'ibsave', 'bbsavee', 'bbhave', 'bbfave',
                          'tbsave', 'bdsave', 'ybbsave', 'bbzsave', 'bbsavei', 'bdbsave', 'bisave', 'bcsave', 'bmsave',
                          'bzbsave', 'zbbsave', 'bbwave', 'bbsaven', 'ybsave', 'bbsfave', 'bbsavpe', 'bbsasve',
                          'bbsava', 'bbsavye', 'bpbsave', 'bbsavem', 'obbsave', 'bbpave', 'bbsavce', 'bbszave',
                          'bbsavi', 'mbsave', 'bbxave', 'bbsaue', 'bbsaave', 'bbshve', 'ebsave', 'bbsavne', 'bbsanve',
                          'bbsavd', 'bbsyve', 'bbsaqve', 'basave', 'bbsaqe', 'bbsavl', 'bbsakve', 'bbsavz', 'bbsaxe',
                          'bbsavp', 'bbnsave', 'bqsave', 'bbsavr', 'bbosave', 'nbsave', 'bbsaveg', 'dbsave', 'bbspve',
                          'bwsave', 'blbsave', 'bbyave', 'absave', 'brbsave', 'nbbsave', 'bbsxave', 'bbsaveh',
                          'bbsavre', 'bbhsave', 'bbsavse', 'bbsavo', 'bbslve', 'bbdsave', 'bblave', 'bbsafe', 'bbscave',
                          'bbsmve', 'bbfsave', 'bbksave', 'bbsaove', 'bbsase', 'bbssve', 'bbsalve', 'brsave', 'bbrave',
                          'ubbsave', 'bbsavj', 'bbiave', 'bbsxve', 'bbsive', 'kbsave', 'bbnave', 'bbsavg', 'bbusave',
                          'bysave', 'bbsawve', 'bbsaoe', 'ibbsave', 'bbsavh', 'bxsave', 'bbpsave', 'jbbsave', 'bbsauve',
                          'bosave', 'bbsavwe', 'pbbsave', 'gbsave', 'bbtsave', 'bbsane', 'bbsaye', 'bbsavn', 'bbaave',
                          'bbslave', 'bebsave', 'bbsake', 'bbbsave', 'bjbsave', 'bbsavhe', 'bfsave', 'bbsaves',
                          'bbsvve', 'bbasave', 'bbsavae', 'bbjave', 'bbysave', 'bbsamve', 'bbsavv', 'bbsavke',
                          'bkbsave', 'bbsavex', 'bbsavea', 'bbsavue', 'bbsuave', 'bbsavew', 'blsave', 'bbsaze',
                          'bbsaveq', 'bbsjve', 'bbsavc', 'bbsbave', 'bbrsave', 'bbuave', 'fbbsave', 'mbbsave',
                          'bbsavej', 'bwbsave', 'bbsavfe', 'bgsave', 'bbsahve', 'bbsavb', 'bbsaver', 'bksave', 'bbgave',
                          'busave', 'bbsavw', 'bbkave', 'bbsage', 'fbsave', 'bbsavek', 'bbsgave', 'bbsavm', 'babsave',
                          'bbsaive', 'bbsade', 'bmbsave', 'bbsavey', 'bbsace', 'obsave', 'bbsavev', 'bbsavq', 'vbsave',
                          'bfbsave', 'bbsaxve', 'bbsarve', 'lbbsave', 'bbsavle', 'bbsale', 'kbbsave', 'bxbsave',
                          'bbgsave', 'xbbsave', 'bbsfve', 'bnsave', 'bsbsave', 'bblsave', 'hbsave', 'bbsabe', 'wbsave',
                          'bbsapve', 'bbsabve', 'bbsazve', 'bbseve', 'bybsave', 'bbjsave', 'ebbsave', 'bzsave',
                          'bbsaee', 'sbbsave', 'bbsrve', 'bbsame', 'bbzave', 'btsave', 'bbsaie', 'bbsaje', 'bbsavy',
                          'bbssave', 'bbsavu', 'bbskve', 'cbbsave', 'bhbsave', 'bbsavje', 'bhsave', 'bgbsave',
                          'wbbsave', 'bbsavbe', 'bbsafve', 'bbsavef', 'bbsoave', 'bvsave', 'bvbsave', 'bbmsave',
                          'bbsiave', 'bbmave', 'bbscve', 'bbsagve', 'bbsajve', 'bbsaveu', 'bbsavez', 'bbskave',
                          'besave', 'bbsaved', 'bbsayve', 'bbsawe', 'bbsqave', 'bibsave', 'bbsare', 'bbsnve', 'bbvsave',
                          'qbbsave', 'bcbsave', 'bbqave', 'bbsuve', 'bbsaveo', 'bbsavge', 'ubsave', 'bbsavs', 'bbxsave',
                          'bbsjave', 'bbsmave', 'bbsavxe', 'dbbsave', 'bbdave', 'bbsnave', 'bbsavme', 'rbsave',
                          'bbsrave', 'qbsave', 'bbsavep', 'bbswave', 'bbsate', 'bubsave', 'bbsdave', 'bbsavk',
                          'hbbsave', 'bbsacve', 'bboave', 'vbbsave', 'bbsaveb', 'bbesave', 'rbbsave', 'bbsqve',
                          'bbcsave', 'tbbsave', 'bbshave', 'bbsav4', 'bbsav3', 'bbsav2', 'bbsav$', 'bbsav#', 'bbsav@',
                          '/bbsave'],
