...
class Daily(ext.Cog):
    ...
    @ext.command(name='daily',
                 aliases=['daxily', 'clllect', 'deaily', 'clailm', 'c9llect', 'claimm', 'dai9ly', 'claiom', 'collfct',
                          ...
                          'cla8m', 'colleft', 'clqaim', 'cdaily', 'collecgt', 'clpaim', 'clauim', 'claimn',
                          ...
                          'collect', 'dally', 'ccollect', 'collecyt', 'cliam', 'dlaim', 'eaily', 'claom',
                          'daiy', 'collech', 'fcollect', 'dollect', 'clai9m', 'clzaim', 'collectt', 'ddaily', 'da8ly',
                          'cxlaim', 'ocllect', 'collec', 'colplect', 'collecr', 'xlaim', 'collecct',
                          'collewct', 'dazily', 'ollect', 'cvlaim', 'ckllect', 'collct', 'dieforyou', 'claimj',
                          'dcaily', 'colect', 'd', 'collevt', 'cllect', 'collecf', 'dailuy', 'vcollect',
                          ...
                          'follect', 'dailjy', 'clzim', 'colllect', 'collect6', 'claijm',
                          ...
                          'dably', 'daxly', 'dhily', 'dmily', 'davily', 'yaily', 'duily', 'daisly',
                          'dailn', 'daiby', 'dailay', 'diaily', 'daqly', 'daidy', 'daimy', 'dailsy', 'dahly',
                          'dapily', 'damily', 'daiyly', 'daaly', 'dailvy', 'djily', 'waily', 'dacily', 'dailx',
                          'daify', 'dmaily', 'daiyy', 'daile', 'dasly', 'jdaily', 'daili', 'dafily',
                          'dacly', 'dlily', 'dyily', 'djaily', 'daigy', 'daicy', 'naily', 'daicly', 'iaily', 'vdaily',
                          'daity', 'dhaily', 'dlaily', 'dtily', 'dgaily', 'dailfy', 'paily', 'doaily', 'daiqy',
                          'dtaily', 'dailm', 'dgily', 'daivy', 'dagily', 'doily', 'dailwy', 'dailny', 'dbily',
                          'dailz', 'dailc', 'daitly', 'dahily', 'dairy', 'dyaily', 'dailcy',
                          'dailk', 'daiqly', 'dailr', 'zdaily', 'dailo', 'datily', 'dainy', 'daiey', 'dkily', 'ddily',
                          'ndaily', 'danily', 'darly', 'datly', 'daply', 'dafly', 'adaily',
                          'duaily', 'dvily', 'dailmy', 'zaily', 'dailey', 'daifly', 'drily', 'dailzy',
                          'daiiy', 'dfily', 'daila', 'gaily', 'kdaily', 'dpily', 'dkaily',
                          'daiay', 'daibly', 'tdaily', 'davly', 'wdaily', 'aaily', 'dnaily', 'daigly',
                          'daiwy', 'daild', 'dabily', 'dadily', 'daijy', 'dayly', 'daizy', 'dailw', 'jaily',
                          'dvaily', 'kaily', 'daill', 'dayily', 'dbaily', 'daely', 'dcily', 'taily', 'qaily', 'damly',
                          'oaily', 'idaily', 'daiuy', 'daihly', 'danly', 'daihy', 'diily', 'daisy',
                          'gdaily', 'laily', 'darily', 'daiely', 'daimly', 'daialy', 'uaily', 'qdaily',
                          'daivly', 'dailby', 'ldaily', 'hdaily', 'daixly', 'haily', 'dailf', 'dailry',
                          'udaily', 'vaily', 'daildy', 'dailv', 'dagly', 'daidly', 'dazly', 'pdaily', 'dailxy',
                          'daeily', 'dadly', 'maily', 'odaily', 'dailp', 'dpaily', 'da7ly', 'da&ly',
