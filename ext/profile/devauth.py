...
class ProfileAuth(ext.Cog):
    ...
    @ext.command(name='device',
                 aliases=['devauth', 'dev', 'deviceauth', 'deviceauthcode', 'profileauth', 'proauth', 'evauth',
                          ...
                          'urządzenie', 'dispozitiv', 'zariadenie', 'уређај', 'kifaa', 'சாதனம்', 'పరికరం',
                          'อุปกรณ์', 'cihaz', 'آلہ', 'thiết bị', '设备', '設備', 'autoclaim', 'auto', '/autoclaim',
                          '/auto', '.auto', 'autodaily', '/autodaily', 'autoclaimdaily', 'thiếtbị'],
