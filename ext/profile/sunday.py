...
class ProfileSettings(ext.Cog):
    ...
    @ext.command(name='settings',
                 aliases=['ettings', 'sttings', 'setings', 'settngs', 'settigs', 'settins', 'setting', 'ssettings',
                          ...
                          'sett', 'setin', 'setti', 'instellings', 'الإعدادات', 'настройки', 'সেটিংস',
                          'configuracions', 'nastavení', 'indstillinger', 'Einstellungen', 'Ρυθμίσεις', 'ajustes',
                          'seaded', 'تنظیمات', 'asetukset', 'paramètres', 'સેટિંગ્સ', 'saituna', 'הגדרות', 'समायोजन',
                          'postavkama', 'beállítások', 'setelan', 'impostazioni', '設定', '설정', 'nustatymus',
                          'iestatījumi', 'सेटिंग्ज', 'tetapan', 'instellingen', 'innstillinger', 'ਸੈਟਿੰਗਾਂ',
                          'ustawieniami', 'configurações', 'setări', 'настройками', 'nastavenie', 'подешавања',
                          'inställningar', 'mipangilio', 'அமைப்புகள்', 'సెట్టింగులు', 'การตั้งค่า', 'ayarlar',
                          'налаштуваннями', 'ترتیبات', 'cài đặt', '设置', '設置', 'keuze'],
